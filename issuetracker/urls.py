...
from member.forms import UserSetPasswordForm
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="members/password_reset_confirm.html", form_class=UserSetPasswordForm), name='password_reset_confirm'),
